      ...
      <Container>
        <Box>
          ...
          <Accordion ScrollTrigger={ScrollTrigger} title="O QUE É UM SMART CONTRACT?">
            Um smart contract é um protocolo de computador autoexecutável que facilita, verifica ou faz cumprir a negociação ou desempenho de um contrato, sem a necessidade de intermediários. Ele opera na blockchain e executa automaticamente os termos do contrato quando as condições predefinidas são atendidas. Nosso projeto usa ERC-1155 permite a criação de tokens fungíveis (ERC20) e não fungíveis (ERC721) dentro de um único contrato inteligente
          </Accordion>
        </Box>
        <Box>
